...
public class SpecParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SpecGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVariableOrValueAccess().getAlternatives(), "rule__VariableOrValue__Alternatives");
			...
			builder.put(grammarAccess.getVariableOrValueAccess().getGroup_0(), "rule__VariableOrValue__Group_0__0");
			...
			builder.put(grammarAccess.getVariableOrValueAccess().getVarAssignment_0_1(), "rule__VariableOrValue__VarAssignment_0_1");
			builder.put(grammarAccess.getVariableOrValueAccess().getValAssignment_1(), "rule__VariableOrValue__ValAssignment_1");
			builder.put(grammarAccess.getVariableOrValueAccess().getElementAssignment_2(), "rule__VariableOrValue__ElementAssignment_2");
			...
			builder.put(grammarAccess.getStoreCommandAccess().getValueAssignment_4(), "rule__StoreCommand__ValueAssignment_4");
