...
public class InternalSpecParser extends AbstractInternalAntlrParser {
    ...
    // InternalSpec.g:1082:1: ruleProperty returns [Enumerator current=null] : ( (enumLiteral_0= 'text' ) | (enumLiteral_1= 'class' ) | (enumLiteral_2= 'value' ) ) ;
    public final Enumerator ruleProperty() throws RecognitionException {
        ...
        try {
            // InternalSpec.g:1088:2: ( ( (enumLiteral_0= 'text' ) | (enumLiteral_1= 'class' ) | (enumLiteral_2= 'value' ) ) )
            // InternalSpec.g:1089:2: ( (enumLiteral_0= 'text' ) | (enumLiteral_1= 'class' ) | (enumLiteral_2= 'value' ) )
            {
            // InternalSpec.g:1089:2: ( (enumLiteral_0= 'text' ) | (enumLiteral_1= 'class' ) | (enumLiteral_2= 'value' ) )
            int alt14=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt14) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalSpec.g:1098:3: (enumLiteral_1= 'class' )
                    {
                    // InternalSpec.g:1098:3: (enumLiteral_1= 'class' )
                    // InternalSpec.g:1099:4: enumLiteral_1= 'class'
                    {
                    ...
                    break;
                case 3 :
                    // InternalSpec.g:1106:3: (enumLiteral_2= 'value' )
                    {
                    // InternalSpec.g:1106:3: (enumLiteral_2= 'value' )
                    // InternalSpec.g:1107:4: enumLiteral_2= 'value'
                    {
    ...
    // InternalSpec.g:1117:1: ruleCondition returns [Enumerator current=null] : ( (enumLiteral_0= 'should be' ) | (enumLiteral_1= 'should not be' ) ) ;
    public final Enumerator ruleCondition() throws RecognitionException {
        ...
        try {
            // InternalSpec.g:1123:2: ( ( (enumLiteral_0= 'should be' ) | (enumLiteral_1= 'should not be' ) ) )
            // InternalSpec.g:1124:2: ( (enumLiteral_0= 'should be' ) | (enumLiteral_1= 'should not be' ) )
            {
            // InternalSpec.g:1124:2: ( (enumLiteral_0= 'should be' ) | (enumLiteral_1= 'should not be' ) )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalSpec.g:1125:3: (enumLiteral_0= 'should be' )
                    {
                    // InternalSpec.g:1125:3: (enumLiteral_0= 'should be' )
                    // InternalSpec.g:1126:4: enumLiteral_0= 'should be'
                    {
                    ...
                    break;
                case 2 :
                    // InternalSpec.g:1133:3: (enumLiteral_1= 'should not be' )
                    {
                    // InternalSpec.g:1133:3: (enumLiteral_1= 'should not be' )
                    // InternalSpec.g:1134:4: enumLiteral_1= 'should not be'
                    {
